<frame layout="content content" background={@Mods/StardewUI/Sprites/ShopEntryBorder}
  ...
  <lane orientation="vertical" padding="16">
    ...
    <lane *repeat={:ReminderEntries} *context={:Display} orientation="vertical">
      <!-- main entry -->
      <lane layout="content 36px"
        ...
        <panel horizontal-content-alignment="End" vertical-content-alignment="End">
          ...
          <panel *if={:HasQualityStar} layout="stretch stretch" horizontal-content-alignment="Start" vertical-content-alignment="End">
            <image sprite={:QualityStar} layout="12px 12px"/>
          </panel>
          <digits *if={HasCount} scale="2" number={DisplayCount} />
        </panel>
